...
?>
    ...
    <section class="relative min-h-[600px] flex items-center justify-center text-center px-4 py-10 md:py-16 overflow-hidden">
        ...
        <div class="relative z-10 max-w-4xl mx-auto"> 
            ...
            <div id="ride-status" class="hidden mt-6 bg-gray-800/80 backdrop-blur-sm p-6 rounded-xl shadow-xl text-left animate-slide-up">
                <div class="relative">
                    <h3 class="text-xl font-semibold text-white mb-3 text-center">Booking Confirmed!</h3>
                    
                    <div id="ride-status-loading" class="absolute inset-0 flex items-center justify-center bg-gray-800/95 rounded-xl">
                        <div class="flex flex-col items-center">
                            ...
                            <p class="text-gray-300">Finding your driver...</p>
                        </div>
                    </div>
                    
                    <p class="text-gray-300 mb-2"><span class="font-medium text-gray-100">Status:</span> <span id="status-message">Searching for driver...</span></p>
                    ...
                    <p class="text-gray-300 mb-4"><span class="font-medium text-gray-100">Est. Arrival:</span> <span id="driver-eta">---</span> minutes</p>
                    
                    <div id="driver-card" class="hidden mt-4 p-3 bg-gray-700/60 rounded-lg border border-gray-600 flex items-center space-x-3">
                        ...
                        <div class="flex space-x-2">
                            <button class="p-2 bg-gray-600 rounded-full text-gray-300 hover:bg-primary-600 hover:text-white transition-colors" aria-label="Call driver">
                                <span class="lucide text-lg" aria-hidden="true">&#xea9d;</span>
                            </button>
                            <button class="p-2 bg-gray-600 rounded-full text-gray-300 hover:bg-primary-600 hover:text-white transition-colors" aria-label="Text driver">
                                <span class="lucide text-lg" aria-hidden="true">&#xeb28;</span>
                            </button>
                        </div>
                    </div>
                    
                    <button id="cancel-ride-btn" class="w-full mt-4 bg-red-600 hover:bg-red-700 text-white font-medium py-2 px-4 rounded-lg transition duration-300 focus:outline-none focus:ring-2 focus:ring-red-700 focus:ring-offset-1 focus:ring-offset-gray-800">Cancel Ride</button>
                </div>
            </div>

            <div id="map-canvas" class="animate-fade-in delay-3">
                <div id="map-fallback" class="hidden h-full w-full flex items-center justify-center">
                    <p class="text-gray-400">Map could not be loaded. Please check your connection.</p>
                </div>
            </div>
        </div>
    </section>
