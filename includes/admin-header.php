    ...
    <header class="bg-gray-900/95 backdrop-blur-md fixed top-0 left-0 right-0 z-40 border-b border-gray-700/50 shadow-md">
        <div class="container mx-auto px-4 lg:px-6 flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex items-center space-x-6">
                <a href="admin-dashboard.php" class="<?php echo ($currentPage == 'admin-dashboard') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300">
                    <span class="lucide mr-1" aria-hidden="true">&#xeaae;</span>
                    Dashboard
                </a>
                <a href="admin-drivers.php" class="<?php echo ($currentPage == 'admin-drivers') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300">
                    <span class="lucide mr-1" aria-hidden="true">&#xebe4;</span>
                    Drivers
                </a>
                <a href="admin-rides.php" class="<?php echo ($currentPage == 'admin-rides') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300">
                    <span class="lucide mr-1" aria-hidden="true">&#xeb15;</span>
                    Rides
                </a>
                <a href="admin-analytics.php" class="<?php echo ($currentPage == 'admin-analytics') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300">
                    <span class="lucide mr-1" aria-hidden="true">&#xea22;</span>
                    Analytics
                </a>
                ...
                <div class="relative">
                    ...
                    <div id="admin-dropdown-menu" class="absolute right-0 top-full mt-2 w-48 bg-gray-800 border border-gray-700 rounded-lg shadow-lg z-50 hidden">
                        <ul class="py-2">
                            <li class="border-b border-gray-700">
                                <span class="block px-4 py-2 text-sm text-gray-400">Signed in as</span>
                                <span class="block px-4 py-2 text-sm font-medium text-white"><?php echo htmlspecialchars($_SESSION['admin_username']); ?></span>
                            </li>
                            <li class="border-t border-gray-700 mt-2 pt-2">
                                <a href="admin-logout.php" id="logout-link" class="block px-4 py-2 text-red-400 hover:bg-gray-700 hover:text-red-300 transition duration-300">
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-gray-800/95 backdrop-blur-md border-b border-gray-700/50 shadow-lg">
            <div class="container mx-auto px-4 py-3 space-y-3">
                <a href="admin-dashboard.php" class="block <?php echo ($currentPage == 'admin-dashboard') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300 py-2">
                    <span class="lucide mr-1" aria-hidden="true">&#xeaae;</span>
                    Dashboard
                </a>
                <a href="admin-drivers.php" class="block <?php echo ($currentPage == 'admin-drivers') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300 py-2">
                    <span class="lucide mr-1" aria-hidden="true">&#xebe4;</span>
                    Drivers
                </a>
                <a href="admin-rides.php" class="block <?php echo ($currentPage == 'admin-rides') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300 py-2">
                    <span class="lucide mr-1" aria-hidden="true">&#xeb15;</span>
                    Rides
                </a>
                <a href="admin-analytics.php" class="block <?php echo ($currentPage == 'admin-analytics') ? 'text-primary-400' : 'text-gray-300 hover:text-primary-400'; ?> transition duration-300 py-2">
                    <span class="lucide mr-1" aria-hidden="true">&#xea22;</span>
                    Analytics
                </a>
                
                <div class="border-t border-gray-700 mt-2 pt-2">
                    <span class="block text-sm text-gray-400 py-1">Signed in as <span class="text-white"><?php echo htmlspecialchars($_SESSION['admin_name']); ?></span></span>
                    <a href="admin-logout.php" id="mobile-logout-link" class="block text-red-400 hover:text-red-300 transition duration-300 py-2">
                        <span class="lucide mr-2" aria-hidden="true">&#xea7b;</span>
                        Log Out
                    </a>
                </div>
