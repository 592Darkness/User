...
$errorMessage = isset($_GET['message']) ? sanitize($_GET['message']) : 'An unexpected error occurred.';
...
<section class="flex items-center justify-center min-h-[70vh] px-4 py-16">
    <div class="max-w-md text-center">
        <div class="mb-8">
            <span class="lucide text-red-500 text-8xl mb-4 inline-block" aria-hidden="true">&#xea0e;</span>
            <h1 class="text-4xl font-bold text-white mb-4">Server Error</h1>
            <p class="text-lg text-gray-400"><?php echo htmlspecialchars($errorMessage); ?></p>
        </div>
        ...
        <div class="space-y-4">
            ...
            <p class="text-gray-500 text-sm mt-8">
                If this error persists, please <a href="#" class="text-primary-400 hover:text-primary-300">contact our support team</a>.
            </p>
        </div>
    </div>
</section>
