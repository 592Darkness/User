...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex gap-2">
            ...
            <button type="button" onclick="toggleFilterPanel()" class="bg-gray-700 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg transition duration-300 shadow-md">
                        ...
                        <tr class="hover:bg-gray-700/50 transition-colors">
                            ...
                            <td class="py-3 px-4 text-center">
                                <div class="flex items-center justify-center space-x-2">
                                    <button onclick="openViewRideModal(<?php echo $ride['id']; ?>)" class="p-1.5 bg-blue-500/20 text-blue-400 rounded-lg hover:bg-blue-500/30 transition-colors" title="View Details">
                                        <span class="lucide" aria-hidden="true">&#xea6d;</span>
                                    </button>
                                </div>
                            </td>
...
<div id="view-ride-modal" class="fixed inset-0 z-50 items-center justify-center hidden">
    ...
    <div class="modal-content bg-gray-800 shadow-2xl border border-gray-700 max-w-lg w-full mx-auto relative z-10">
        <button type="button" class="modal-close-btn text-gray-500 hover:text-primary-400 absolute right-4 top-4 focus:outline-none focus:text-primary-500" aria-label="Close modal" onclick="closeModal('view-ride-modal')">
            <span class="lucide" aria-hidden="true">&#xea76;</span>
        </button>
        ...
        <div class="mt-6 flex justify-end">
            <button type="button" onclick="closeModal('view-ride-modal')" class="bg-gray-600 hover:bg-gray-500 text-white font-medium py-2 px-4 rounded-lg transition duration-300">
                Close
            </button>
        </div>
    </div>
